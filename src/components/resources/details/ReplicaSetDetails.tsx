...
export const ReplicaSetDetails: React.FC<ReplicaSetDetailsProps> = ({ replicaSet, explanation, onExplain, isExplaining, onNavigate, onShowTopology, clusterName }) => {
        ...
        <div className="space-y-8 text-sm">
            ...
            {showTopology && clusterName && (
                <div className="border border-purple-500/30 rounded-lg overflow-hidden bg-black/20">
                    <ResourceTopology clusterName={clusterName} resource={replicaSet} />
                </div>
            )}

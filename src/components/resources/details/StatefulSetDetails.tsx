...
export const StatefulSetDetails: React.FC<StatefulSetDetailsProps> = ({ statefulSet, explanation, onExplain, isExplaining, onShowTopology, clusterName }) => {
        ...
        <div className="space-y-8 text-sm">
            ...
            {showTopology && clusterName && (
                <div className="border border-purple-500/30 rounded-lg overflow-hidden bg-black/20">
                    <ResourceTopology clusterName={clusterName} resource={statefulSet} />
                </div>
            )}
            ...
            <div>
                ...
                <div className="bg-white/5 rounded-md overflow-hidden border border-white/10">
                     <div className="p-3 border-b border-white/10 flex justify-between">
                        ...
                        <span className="text-white">{status.currentReplicas || 0} / {spec.replicas}</span>
                     </div>
                     <div className="p-3 border-b border-white/10 flex justify-between">
                        <span className="text-gray-400">Ready</span>
                        <span className="text-white">{status.readyReplicas || 0}</span>
                     </div>
                     <div className="p-3 border-b border-white/10 flex justify-between">
                        <span className="text-gray-400">Service Name</span>
                        <span className="text-white font-mono">{spec.serviceName}</span>
                     </div>
                     <div className="p-3">
